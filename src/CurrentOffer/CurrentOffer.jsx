    ...
    <div className="py-6 w-full">
      ...
      <div className="text-center flex flex-col justify-center items-center">
        <img
          ...
          alt=""
        />
        <h4 className="text-xl font-semibold">QLED Gaming Monitor</h4>
        <h3 className="text-lg text-slate-700">
          Exclusive offers on ultra wide Gaming monitors
        </h3>
        <div>
          <button className="flex items-center justify-around gap-3 p-3 m-7 px-20 bg-blue-500 rounded-lg text-lg font-medium">
            Shop Now{" "}
